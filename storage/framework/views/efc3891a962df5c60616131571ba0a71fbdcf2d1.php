  ...
  <header class="masthead">
    <div class="container d-flex h-100 align-items-center">
      <div class="mx-auto text-center">
        ...
        <a href="espacemembre.html" class="btn btn-primary js-scroll-trigger">Espace membre</a>
      </div>
    </div>
  </header>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 mx-auto">
          <h2 class="text-white mb-4">Construit par Mouhamed Mbaye</h2>
          <p class="text-white-50">WORLD PICTURE est un site web dédié au partage de photos sous licence libre. Il est basé à Dakar , la capitale du Sénégal . Le site compte plus de 120 000 photographes contributeurs et génère plus de 10 milliards « d'impressions » par mois et dispose de plus de 1 milliard de photos haute-définition libres
...
<?php /**PATH /home/sognane/www/banque/resources/views/index.blade.php ENDPATH**/ ?>